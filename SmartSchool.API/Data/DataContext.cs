        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, "Guilherme"),
                    new Professor(2, "Roberto"),
                    new Professor(3, "Giulia"),
                    new Professor(4, "Cristiane"),
                    new Professor(5, "Renato"),
                });
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, "Fatima", "Pineda", "33225555"),
                    new Aluno(2, "Isabella", "Martins", "3354288"),
                    new Aluno(3, "Pietro", "Pineda", "55668899"),
                    new Aluno(4, "Roberta", "Pineda", "6565659"),
